                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                if (isset($_REQUEST['filter'])) {
                                    ...
                                    {
                                        if($name!=""){ $n = " Class='$name' AND ";} else{$n="";}
                                       if($gender!=""){ $g = " Gender='$gender' AND ";} else{$g="";}
                                       if($bloodgroup!=""){ $bg = " Bloodgroup='$bloodgroup' AND ";} else{$bg="";}
                                       if($country!=""){ $c = " Country='$country' AND ";} else{$c="";}
                                       if($state!=""){ $s = " State='$state' AND ";} else{$s="";}
                                       if($stype!=""){ $type = " Stype='$stype' AND ";} else{$type="";}
                                       if($designation!=""){ $desgi = " Desgination='$designation' AND ";} else{$desgi="";}
                                       if($from_dob!=""){ $dob = " Dob BETWEEN '$from_dob' AND '$to_dob' AND ";} else{$dob="";}
                                       if($from_doj!=""){ $doj = " Doj BETWEEN '$from_doj' AND '$to_doj' AND ";} else{$doj="";}
                                       if($from_edate!=""){ $edate = " Enroll_date BETWEEN '$from_edate' AND '$to_edate' AND ";} else{$edate="";}
