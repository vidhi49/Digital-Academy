	...
	<div class="container p-5">
		<form method="post">
			<div class="form-group">
				<h1 class="mb-5 text-left text-danger"> Personal Details
					<hr>
				</h1>
			</div>
			<div class="mb-4">
			...
			<div class="mb-5">
				<h1 class="mb-5 text-left text-danger"> Document Upload
					<hr>
				</h1>
			...
			<div class="mb-3">
				<h1 class="mb-5 text-left text-danger">Document Details
					<hr>
				</h1>
