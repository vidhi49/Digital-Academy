              ...
              <div class="form-group row">
                <div class="col-sm-2">
                  ...
                  <?php
                                    ...
                                    $num = $result->num_rows;
                                    if ($num > 0) {
                                        echo ' <select   name="cclass" onchange="classDropdown(this.value)" class="form-control m-1">';
                ...
                <div class="col-sm-2">
                  ...
                  <?php
                                    echo ' <select    name="ssection" id="section" onchange="grnodropdown(this.value);totamountdropdown(this.value)" class="form-control  m-1">';
                ...
                <div class="col-sm-2">
                  ...
                  <?php
                                    echo ' <select name="ggrno" id="grno" onchange="snamedropdown(this.value)" class="form-control m-1">';
                                    echo "<option value=''>--Grno--</option>";
                                    echo "</select>";
                                    ?>
                </div>
                <div class="col-sm-2">
                  <label class="form-control-label ml-2 p-1">Student-Name <span
                      class="text-danger ml-2">*</span></label>
                  <?php
                                    echo ' <select name="ssname" id="sname"  class="form-control  m-1"  >';
                ...
                <div class="col-sm-2">
                  ...
                  <?php
                                    echo ' <select name="ttotalfee" id="totalfee"  class="form-control m-1"  >';
                ...
                <div class="col-sm-2">
                  ...
                  <input type="number" class="form-control" name="paid_amount"
                    value="<?php if (isset($row['Id'])) echo $row['Paid_amount']; ?>" required placeholder="Amount">
                </div>
              </div>
              <?php
                            if (isset($Id)) {
