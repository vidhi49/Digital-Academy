...
<div class="modal fade bd-example-modal-lg" id="img1" tabindex="0" role="dialog" aria-labelledby="myLargeModalLabel"
  aria-hidden="true">
  <div class="modal-dialog modal-sm modal-dialog-zoom modal-dialog-centered">
          ...
          <div class="row">
            <div class="col bg-c-lite-green m-3 text-center d-flex align-items-center p-5 ">
              <div class="text-white m-auto">
                <img id="popup-img1" height="150" style="border-radius: 50%;" width="150" src="" alt="image">
