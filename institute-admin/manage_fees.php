...
<body>
  <div class="d-flex">
    ...
    <div class="institute-content">
        ...
        <div style="box-shadow: rgba(0, 0, 0, 0.30) 0px 3px 8px;">
          ...
          <div class="row m-3">
            ...
            <div class="col-sm-6">
              ...
              <input type="number" step="any" min="0" class="form-control form-control-lg text-right" name="amount">
            </div>
          ...
          <?php
                    if (isset($Id)) {
                    ?>
          <button type="submit" name="update" class="btn btn-warning m-2">Update</button>
          <?php
                    } else {
                    ?>
          <button type="submit" name="save" class="btn btn-primary m-2">Add to list</button>
          <?php
                    }
                    ?>
          <!-- </div> -->
      ...
      <div class="row mt-5 d-flex justify-content-center align-items-center" id="studtable"
        ...
        <div class="table-responsive p-3 ">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-primary" type="submit"
              onclick="location.href = ' Courses-Fees.php'">Save</button>
