                  ...
                  <div class="col-sm-8">
                    ...
                    <div class="row m-2">
                      ...
                      <select class="form-control form-control-lg m-1" name="gender" required>
                        ...
                        <option value="Female" <?php if ($r['Gender'] == 'Female') echo ' selected'; ?>> Female
                        </option>
            ...
            <div class="card-body ">
              ...
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <input class="doj form-control form-control-lg m-1" type="date" id="doj"
                    value="<?php echo  $r['Doj'] ?>" name="doj" required>
