          ...
          <div class="card mb-4 " style='box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;'>
            ...
            <div class="card-body py-3">
              <div class="form-group">
                <div class="row">
                  <div class="col-sm-4">
                    <div class="row upload d-flex  justify-content-center text-center pb-3 pt-2">
                      <img id="profileimg" class="img w-75 h-50 " src='student_profile/<?php echo $r['Profile']; ?>'
                  ...
                  <div class="col-sm-8">
                    ...
                    <div class="row m-2">
                      ...
                      <input type="text" class="form-control form-control-lg m-1" id="fname" name="fname"
                        value="<?php echo  $r['Father_name'] ?>" placeholder="First Name/Surname" required>
                    ...
                    <div class="row m-2">
                      ...
                      <input type="text" class="form-control form-control-lg m-1" id="mname" name="mname"
                        value="<?php echo  $r['Mother_name'] ?>" placeholder="First Name/Surname" required>
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-sm-3">
                    ...
                    <input class="form-control form-control-lg m-1" type="tel" value="<?php echo  $r['Mobileno'] ?>"
                  ...
                  <div class="col-sm-3">
                    ...
                    <input type="text" class="form-control form-control-lg m-1" id="e"
            ...
            <div class="card-body ">
              ...
              <div class="row">
                ...
                <input class="form-control form-control-lg m-1" type="text" id="aca_year"
                  value="<?php echo $r['Academicyr']; ?>" name="aca_year" readonly required>
              </div>


              <input type="submit" name="submit" id="submit" class="btn  btn-danger m-2">
            </div>
          </div>
        </form>
