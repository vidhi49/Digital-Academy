...
<body>
    <div class="d-flex">
        ...
        <div class="institute-content  text-muted">
            ...
            <div class="row m-5 bg-white" id="atttable" style="display:none;border-radius:10px;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
            ...
            <div class="row m-5 bg-white" id="datewiseatt" style="display:none;border-radius:10px;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px; ">
            ...
            <div class="row m-5 bg-white" id="rangewiseatt" style="display:none;border-radius:10px;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px; ">
