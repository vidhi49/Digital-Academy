...
<body>
  <div class="d-flex">
    ...
    <div class="institute-content">
          ...
          <div class="card shadow bg-white " style="border-radius: 20px;">
            <div class="card-body p-4">
              <div class="row">
                ...
                <div class="col-6">
                  <svg class="primary-icon float-right" width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="row mx-1 " > 
        <div class="col-6 mt-5" style="margin-right:50px;border-radius: 20px;background-color:white;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
          <center>
        ...
        <div class="col mt-5" style="border-radius: 20px;background-color:white;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
          <h3 class="m-3 text-center">Student Attendance</h3>
          <div>
