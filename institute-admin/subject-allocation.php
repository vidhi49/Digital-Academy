...
if (isset($_POST['save'])) {
    ...
    // echo $result[0];
    $q1 = "select Section from class_tbl where Id='$section' and Insti_id='$Ins_id'";
...
if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "edit") {
    ...
    $query = mysqli_query($con, "select * from teacher_wise_subject_tbl where Id ='$Id' AND Inst_id='$Ins_id'");
    ...
    if (isset($_POST['update'])) {
        ...
        $tid = $_POST['tid'];
        $subCode = $_POST['subcode'];
        $q1 = "select Sub_name from subject_tbl where Sub_code='$subCode' AND Inst_id='$Ins_id'";
        $res1 = mysqli_query($con, $q1);
        $result1 = mysqli_fetch_array($res1);
        $que = mysqli_query($con, "update teacher_wise_subject_tbl set Teacher_id='$tid' ,Teacher_name='$tname',Sub_code='$subCode',Sub_name='$result1[0]' where Id='$Id' AND Inst_id='$Ins_id'");
        if ($que) {
...
if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "delete") {
    ...
    $query = mysqli_query($con, "DELETE FROM teacher_wise_subject_tbl WHERE Id='$Id' AND Inst_id='$Ins_id'");
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-xl-6">
                                ...
                                if (isset($Id)) {
                                    ...
                                    $qry = "SELECT  * FROM class_tbl where Name='$res1[4]' AND Insti_id='$Ins_id' ORDER BY Section ASC";
                                    $result = $con->query($qry);
                                    $num = $result->num_rows;
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-xl-5">
                            ...
                            if (isset($Id)) {
                                ...
                                $qry = "SELECT  * FROM staff_tbl where Name='$res1[2]' AND Inst_id='$Ins_id' ORDER BY Email ASC";
                                $result = $con->query($qry);
                                $num = $result->num_rows;
                                if ($num > 0) {
                        ...
                        <div class="col-xl-2">
                            ...
                            if (isset($Id)) {
                                ...
                                $qry = "SELECT  * FROM staff_tbl where Id='$res1[1]' AND Inst_id='$Ins_id' ORDER BY Email ASC";
                                $result = $con->query($qry);
                                $num = $result->num_rows;
                                if ($num > 0) {
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-xl-6">
                            ...
                            if (isset($Id)) {
                                ...
                                $qry = "SELECT  * FROM subject_tbl where Sub_code='$res1[5]' AND Inst_id='$Ins_id'";
                                $result = $con->query($qry);
                                $num = $result->num_rows;
                                if ($num > 0) {
