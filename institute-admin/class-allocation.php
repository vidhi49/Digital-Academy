        ...
        <form method="post">
          <div class="form-group row mb-3">
            <div class="col-xl-6">
              ...
              $num = $result->num_rows;
              if ($num > 0) {
                echo ' <select required name="name"  onchange="(this.value)" class="form-control mb-3">';
            ...
            <div class="col-xl-6" id="hello">
              ...
              <?php
              if (isset($Id)) {
                $qry = "SELECT  * FROM class_tbl where Id='$Id' ORDER BY Section ASC";
                $result = $con->query($qry);
                $num = $result->num_rows;
                if ($num > 0) {
      ...
      <div class="card-body">
        ...
        <div class="form-group row mb-3">
          ...
          <div class="col-xl-5">
            ...
            <select required name="temail" id='emailHint' onchange='teacherDropdown(this.value)'
          ...
          <div class="col-xl-2">
            ...
            <select required name='tid' id='tidHint' class="form-control mb-3">
