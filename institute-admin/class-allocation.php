        ...
        <form method="post">
          <div class="form-group row mb-3">
            <div class="col-xl-6">
              ...
              $num = $result->num_rows;
              if ($num > 0) {
                echo ' <select required name="name" ' . $readonly . '  onchange="classDropdown(this.value)" class="form-control mb-3">';
            ...
            <div class="col-xl-6" id="hello">
              ...
              if (isset($Id)) {
                ...
                $num = $result->num_rows;
                if ($num > 0) {
                  echo ' <select required ' . $readonly . '  name="section" id="txtHint"  class="form-control mb-3">';
                ...
                echo ' <select required  name="section" id="txtHint"  class="form-control mb-3">';
        ...
        <div class="form-group row mb-3">
          ...
          <div class="col-xl-5">
            ...
            if (isset($Id)) {
              ...
              $res1 = mysqli_fetch_array($res);
              if ($res1[3] != "") {
                $qry = "SELECT  * FROM staff_tbl where Name='$res1[4]' ORDER BY Email ASC";
                $result = $con->query($qry);
                $num = $result->num_rows;
                if ($num > 0) {
          ...
          <div class="col-xl-2">
            ...
            if (isset($Id)) {
              ...
              $res1 = mysqli_fetch_array($res);
              if ($res1[3] != "") {
                $qry = "SELECT  * FROM staff_tbl where Id='$res1[3]' ORDER BY Email ASC";
                $result = $con->query($qry);
                $num = $result->num_rows;
                if ($num > 0) {
