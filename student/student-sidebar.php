...
<body>
  <div class="d-flex flex-column student-sidebar flex-shrink-0 p-3 text-white" id='student-sidebar' style="box-shadow: inset 0 10px 15px -6px black;"> <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none"> <svg class="bi me-2" width="40" height="32"> </svg> <span class="fs-5 span">Welcome </span> </a>
    <hr>
    <ul class="navbar-nav nav-pills flex-column mb-auto">
      ...
      <li class="nav-item"> <a href="student-dashboard.php" aria-current="page" <?php
        ...
        <a href="viewProfile.php" <?php
                                    ...
                                    ?>>
          <i class="fa fa-users" aria-hidden="true"></i><span class="ms-2 span">View Profile</span>
        </a>
      </li> -->
    ...
    <div class="dropdown"> <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false"> <img src="https://github.com/mdo.png" alt="" width="32" height="32" class="rounded-circle me-2"> <strong> John W </strong> </a>
      <ul class="dropdown-menu dropdown-menu-dark text-small shadow" aria-labelledby="dropdownUser1">
        ...
        <li><a class="dropdown-item text-dark" href="viewProfile.php">Profile</a></li>
        <li>
