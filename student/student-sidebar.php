...
<body>
  <div class="d-flex flex-column student-sidebar flex-shrink-0 vh-100 p-3 text-white" id='student-sidebar'
    style="box-shadow: inset 0 10px 15px -6px black;"> <a href="#"
      class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none"> <svg class="bi me-2"
        width="40" height="32"> </svg>
      <!-- <span class="fs-5 span">Welcome </span> </a> -->
      <hr>
      <ul class="navbar-nav nav-pills flex-column mb-auto fs-6">
        ...
        <li class="nav-item">
          <a href="viewSubject.php" <?php
            ...
            <span class="ms-2 span"> View Subject</span>
          </a>
        </li>
        <li class="nav-item"> <a href="subjectMaterial.php" <?php
                                                            ...
                                                            ?>>
            <i class="fa fa-book" aria-hidden="true"></i><span class="ms-2 span"> Material </span>
          </a>
        </li>
