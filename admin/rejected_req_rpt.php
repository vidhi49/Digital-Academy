<?php
    ...
    class myPDF extends FPDF{
        ...
        function headerTable(){
            ...
            $this->Cell(276,5,'REJECTED REQUEST',0,0,'C');
            $this->Ln();
            $this->SetFont('Times','',12);
            $this->Cell(276,10,'List of Rejected Request',0,0,'C');
            $this->Ln(20);
            ...
            $this->Cell(40,10,'Date of Rejection',1,1,'C');
        ...
        function viewTable($db){
            ...
            $stmt=$db->query("select * from inquiry_tbl where status='Rejected'");
