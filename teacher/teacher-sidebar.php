    ...
    <ul class="nav nav-pills flex-column mb-sm-auto align-items-center align-items-sm-start" id="menu">
      ...
      <li class="nav-item m-1">
        <a href="#homeSubmenu" data-toggle="collapse" aria-expanded="false"
          class="dropdown-toggle nav-link align-middle px-0 text-white"><i class="fas fa-folder-open fs-5 mr-2"></i> Exam
        </a>
        <ul class="collapse list-unstyled" id="homeSubmenu">
          ...
          <li>
            <a href="manageExam.php" class="nav-link float-right text-white">Manage Exam</a>
          </li>
          <!-- <li>
            <a href="#">Home 3</a>
          </li> -->
