						...
						<table width="200" border="0" align="justify">
						  <tbody style="color: white">
						    ...
						    <tr> <td width="43" align="center">
								  <i class="fa fa-envelope" style="font-size:20px"></i></td>
						      <td width="141"><strong>Email:</strong></td></tr>
						    <tr><td></td><td>abc@gmail.com<br><br><br></td></tr>
							  
						    <tr><td height="34" align="center">
								<i class="fa fa-phone  "  style="font-size:20px"></i></td>
						      <td><strong>Phone:</strong></td></tr>
							  
						    <tr><td>&nbsp;</td><td>+91 123 456 7890<br><br><br></td></tr>
							  
						    <tr><td height="33" align="center">
								<i class="fa fa-globe" aria-hidden="true" style="font-size:25px"></i></td>
						      <td><strong>Website:</strong></td></tr>
							  
						    <tr><td>&nbsp;</td>
						      <td>dgskool@gmailcom</td></tr>
